...
achieves 80 \% accuracy on the classification problem.
We also demonstrate that Gaussian process regression estimators
achieve a median R-squared score of 0.98 for estimating the latency and 0.95 for
estimating the throughput while executing a SQL workload under a given
DBMS configuration.
\end{abstract}
